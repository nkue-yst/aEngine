...
namespace aengine
{
    ...
    PlaybackHandle IAudioEngine::MakePlaybackHandle(std::uint32_t index, std::uint64_t version) const
    {
        if (version == 0U)
        {
        ...
        return PlaybackHandle(index, version, this->PlaybackOwnerToken);
    }
